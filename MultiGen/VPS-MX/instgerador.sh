...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1Rob255RHJvaWRZVC9URC1HZW4vbWFzdGVyL011bHRpR2VuL1ZQUy1NWC9nZXJhZG9y"
#SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1Rob255RHJvaWRZVC9GcmVlLVZQUy9tYXN0ZXI="
SUB_DOM='base64 -d'
rm $(pwd)/$0
...
function_verify () {
  ...
  echo -e "\033[1;31m                CONTACTE A @Thony_DroidYT"
  echo -e "\033[1;31m=====================================================\n\n\n"
