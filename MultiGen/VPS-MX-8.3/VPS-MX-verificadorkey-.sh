...
rm $(pwd)/$0 &> /dev/null
#20/02/21 [Liberado Por Thony_DroidYT]
#No Editar Esta Información de lo contrario comenzara a dar fallos en los archivos al no detectar la misma escritura!!
### COLORES Y BARRA 
msg () {
